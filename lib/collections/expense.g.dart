...
const ExpenseSchema = CollectionSchema(
  ...
  embeddedSchemas: {r'SubCatgory': SubCatgorySchema},
  getId: _expenseGetId,
...
int _expenseEstimateSize(
  ...
  }
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          SubCatgorySchema.estimateSize(
              value, allOffsets[SubCatgory]!, allOffsets);
    }
  }
  return bytesCount;
}
...
void _expenseSerialize(
  ...
  writer.writeObject<SubCatgory>(
    offsets[5],
    allOffsets,
    SubCatgorySchema.serialize,
    object.subCategory,
  );
}
...
Expense _expenseDeserialize(
  ...
  object.subCategory = reader.readObjectOrNull<SubCatgory>(
    offsets[5],
    SubCatgorySchema.deserialize,
    allOffsets,
  );
  return object;
}
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readObjectOrNull<SubCatgory>(
        offset,
        SubCatgorySchema.deserialize,
        allOffsets,
      )) as P;
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, SubCatgory?, QQueryOperations> subCategoryProperty() {
    return QueryBuilder.apply(this, (query) {
...
const SubCatgorySchema = Schema(
  name: r'SubCatgory',
  id: 518880448774807784,
  properties: {
  ...
  estimateSize: _subCatgoryEstimateSize,
  serialize: _subCatgorySerialize,
  deserialize: _subCatgoryDeserialize,
  deserializeProp: _subCatgoryDeserializeProp,
);

int _subCatgoryEstimateSize(
  SubCatgory object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
SubCatgory _subCatgoryDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SubCatgory();
  object.name = reader.readStringOrNull(offsets[0]);
  return object;
}

P _subCatgoryDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension SubCatgoryQueryFilter
    on QueryBuilder<SubCatgory, SubCatgory, QFilterCondition> {
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<SubCatgory, SubCatgory, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension SubCatgoryQueryObject
    on QueryBuilder<SubCatgory, SubCatgory, QFilterCondition> {}
